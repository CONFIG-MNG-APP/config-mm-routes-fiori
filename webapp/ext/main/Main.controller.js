    ...
    return Controller.extend(
      "zgsp26.conf.mng.mmroutes.confmngfemmroutes.ext.main.Main",
      {
        ...
        onInit: function () {
          ...
          console.log("request =", oRequestModel.getData());
        },
        ...
        onCreateRequest: async function () {
          ...
          try {
            ...
            // TODO: sau này thay bằng call backend thật
            ...
            MessageToast.show("Request created successfully: " + sReqId);

            console.log("Create Request with context =", oRequestContext);
          } catch (e) {
            console.error(e);
        ...
        onCreate: async function () {
          try {
            ...
            MessageToast.show("Đã tạo dòng mới");
          } catch (e) {
            console.error(e);
            MessageBox.error("Không tạo được dòng mới");
          }
        },
        ...
        onSubmitRequest: function () {
          ...
          MessageBox.confirm("Submit this request?", {
            onClose: (sAction) => {
              if (sAction === "OK") {
        ...
        onSearch: function () {
          ...
          if (oFilterData.EnvId) {
            aFilters.push(
              new Filter("EnvId", FilterOperator.Contains, oFilterData.EnvId),
            );
          }
          ...
          if (oFilterData.SendWh) {
            aFilters.push(
              new Filter("SendWh", FilterOperator.Contains, oFilterData.SendWh),
            );
          }
            ...
            this._oEnvDialog = new SelectDialog({
              ...
              confirm: (oEvent) => {
                ...
                if (oSelectedItem) {
                  this.getView()
                    .getModel("filter")
                    .setProperty("/EnvId", oSelectedItem.getTitle());
                }
              },
            });
            ...
            this._oPlantDialog = new SelectDialog({
              ...
              confirm: (oEvent) => {
                ...
                if (oSelectedItem) {
                  this.getView()
                    .getModel("filter")
                    .setProperty("/PlantId", oSelectedItem.getTitle());
                }
              },
            });
